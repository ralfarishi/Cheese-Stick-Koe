							...
							<div className="block md:hidden">
								<div className="flex justify-center mb-4">
									<div className="inline-flex items-center gap-2 px-3 py-1.5 bg-success rounded-full">
										...
										<span className="text-xs font-semibold text-white">Sertifikasi Resmi</span>
									</div>
								</div>
								...
								>
									<p className="text-center leading-relaxed text-sm">
										Kami dengan bangga mengumumkan bahwa produk kami telah berhasil memperoleh{" "}
										<span className="font-bold text-success">sertifikasi halal resmi</span>.
									</p>
									...
									<p className="text-center text-xs text-muted">
										Terima kasih atas dukungan dan kepercayaan Anda pada produk halal kami.
									</p>
								</motion.div>
								...
								<div className="flex flex-col justify-center space-y-4">
									...
									>
										<p className="text-sm leading-relaxed">
											Kami dengan bangga mengumumkan bahwa produk kami telah berhasil memperoleh{" "}
											<span className="font-bold text-emerald-500">sertifikasi halal resmi</span>.
										</p>
