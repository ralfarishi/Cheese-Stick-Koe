  ...
  return (
    ...
    >
      ...
      <div className="card overflow-hidden hover:shadow-2xl transition-all duration-500">
        ...
        <div className="relative dark:bg-primary/15 p-6 md:p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            >
              <div className="relative w-16 h-16 md:w-20 md:h-20">
                <Image
                  ...
                  alt={name}
                  fill
                  className="rounded-full object-cover ring-4 ring-white dark:ring-surface-30 shadow-lg"
                />
                {/* Verified Badge */}
                <div className="absolute -bottom-1 -right-1 w-6 h-6 md:w-7 md:h-7 bg-linear-to-br from-success to-success-10 rounded-full flex items-center justify-center ring-3 ring-white dark:ring-surface-30 shadow-md">
                  <svg
            ...
            >
              <h3 className="font-sans! font-bold text-lg md:text-xl  dark:text-bg-white mb-1">
                {name}
              </h3>
