...
export default function Footer() {
	...
	return (
		<footer className="bg-surface-10 text-bg-white relative overflow-hidden" ref={ref}>
			...
			<div className="container-custom relative z-10 py-16">
				<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
					...
					>
						<h3 className="font-logo! text-3xl text-bg-white mb-4">Cheese Stick Koe</h3>
						<p className="text-secondary-300 mb-6 max-w-md">
							Spesialis cheese stick premium dengan keju Edam asli. Kami menyediakan berbagai
							pilihan kue dan minuman rumahan yang lezat untuk keluarga Indonesia.
						</p>
					...
					>
						...
						<div className="space-y-3">
							{contactInfo.map((contact, index) => (
								...
								>
									<div className="text-sm text-secondary-400 mb-1">{contact.label}</div>
