...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="section relative overflow-hidden bg-surface-30"
      ref={ref}
    >
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-secondary-600 dark:text-secondary-400 mt-4">
            ...
            Cheese Stick Keju Edam premium
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mt-12">
          ...
          >
            ...
            {/* Floating Card */}
            <motion.div
              className="absolute -bottom-6 -right-6 bg-white dark:bg-surface-10  p-6 rounded-xl shadow-xl"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-secondary-600 dark:text-secondary-400">
                Kami berkomitmen untuk selalu menghadirkan produk berkualitas
                dengan cita rasa yang konsisten dan memuaskan.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {benefits.map((benefit, index) => (
                <motion.div
                  key={index}
                  className="flex items-center gap-3 p-3 rounded-lg dark:bg-surface-10 dark:hover:bg-surface-20 transition-colors"
                  initial={{ opacity: 0, x: -20 }}
                  animate={inView ? { opacity: 1, x: 0 } : {}}
                  transition={{ delay: 0.4 + index * 0.1 }}
                >
                  <div className="w-5 h-5 rounded-full bg-success-10 dark:bg-primary-500 flex items-center justify-center shrink-0">
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl dark:bg-primary flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                      <feature.icon className="w-6 h-6 dark:text-neutral-200" />
                    </div>
                    <div>
                      <h4 className="font-sans! font-semibold dark:text-bg-white mb-1">
                        {feature.title}
                      </h4>
