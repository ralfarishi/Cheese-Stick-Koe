...
export default function Testimonials() {
	...
	return (
		<section id="testimonials" className="section bg-surface-20 relative overflow-hidden" ref={ref}>
			<div className="container-custom relative z-10">
				...
				>
					...
					<p className="text-neutral-300 mt-4">Kepuasan pelanggan adalah prioritas kami</p>
				</motion.div>
								...
								{testimonials.map((_, index) => (
									<button
										...
										className={`w-2 h-2 rounded-full transition-all duration-300 ${
											index === currentIndex
												? "w-8 bg-primary"
												: "bg-slate-600 hover:bg-secondary-400"
										}`}
