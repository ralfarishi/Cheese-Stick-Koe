...
import { Sen, Courgette, Pattaya } from "next/font/google";

// Self-hosted Google Fonts via next/font (no render-blocking requests)
const sen = Sen({
	subsets: ["latin"],
	display: "swap",
	variable: "--font-sans",
			...
			<ThemeProvider>
				<CartProvider>
					<Head>
						...
						<meta name="title" content="Cheese Stick Koe: Makanan Ringan Bekasi" />
						<meta
							name="description"
						...
						<meta property="og:url" content="https://www.cheesestick-koe.my.id/" />
						<meta property="og:title" content="Cheese Stick Koe: Makanan Ringan Bekasi" />
						<meta
						...
						<meta name="twitter:url" content="https://www.cheesestick-koe.my.id/" />
						<meta name="twitter:title" content="Cheese Stick Koe: Makanan Ringan Bekasi" />
						<meta
					...
					<div className={`${sen.variable} ${courgette.variable} ${pattaya.variable}`}>
						<Component {...pageProps} />
					</div>
					<Analytics />
				</CartProvider>
